...
type CurryFunc<T> = (
  T extends (...args: infer Args) => infer R
    ? Args extends [infer First, ...infer Rest]
      ? (a: First) => CurryFunc<(...args: Rest) => R>
      : R
    : never  
)

declare function Currying<Fn>(fn: Fn): CurryFunc<Fn>

type t1 = (() => void) extends (param1: infer Param1, ...RestArgs: infer Rest) => infer R ? [Param1, Rest] : 0
